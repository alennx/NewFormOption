<template>
    <div style="padding-left:10px;">
        ...
        <Form :model="attributeForm" :label-width="80">
            <div v-if="attr" v-for="(v,k,i) in attr" :key="i">
                <FormItem :label="v.nameCN">
                    <!-- 文本型（text）属性 -->
                    <Input v-if="v.type==='text'" :value="k" v-model="v.value" @on-change="updateAttribute" type="text"></Input>
